  ...
  return (
    <div className="panel" style={{maxWidth:720, margin:'0 auto'}}>
      ...
      <form action="/api/films/create" method="POST">
        ...
        <div style={{height:8}}/>
        <input className="input" name="poster" placeholder="/posters/indie-film-x.jpg (upload via admin/CDN)" />
        <div style={{height:12}}/>
        <button className="btn gold" type="submit">Create & Request Upload URLs</button>
      </form>
      <hr className="sep"/>
      <div className="small">
        After submission, you'll receive direct-upload URLs from Mux (one for the main feature and optionally one for the trailer).
        Upload your files with curl or a browser uploader; when Mux finishes processing, our webhook marks the movie "ready".
      </div>
    </div>
  )
}
